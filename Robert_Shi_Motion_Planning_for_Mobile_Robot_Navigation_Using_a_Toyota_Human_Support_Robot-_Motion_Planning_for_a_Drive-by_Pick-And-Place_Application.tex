...
% Robert_Shi_Motion_Planning_for_Mobile_Robot_Navigation_Using_a_Toyota_Human_Support_Robot:_Motion_Planning_for_a_Drive-by_Pick-And-Place_Application
...
\begin{titlepage}
    ...
    %    \vspace{0.8cm}
        ...
        \vspace{2.0cm}
\end{titlepage}
\includepdf[pages={1}]{declaration_of_authorship}
% \newpage
...
\section{Planning Algorithms}
    ...
    \subsection{Sampling-Based Planning}
        ...
        \subsubsection{PRM}
            ...
            % \par The main issue with PRM is that for every new sample, a k-nearest-neighbor query is performed to identify neighboring nodes within a threshold distance. This computation becomes increasingly expensive as the number of nodes in the PRM increases. 
        ...
        \subsubsection{Bidirectional RRT Variants}
            ...
            \begin{figure}[ht]
                \subfigure[RRT-Connect Algorithm from \cite{kuffner_rrt-connect_2000}]{
                    \includegraphics[width=0.45\linewidth]{images/algorithms/rrt_connect.png}
                    \centering
                    \label{fig:rrt-connect_algo}}
                \quad
                \subfigure[Example of RRT-Connect from \cite{kuffner_rrt-connect_2000}]{
        ...
        \subsection{Procedure}
            ...
            \subsubsection{Object Detection}
                ...
                \begin{figure}[ht]
                    ...
                    \includegraphics[width=0.45\linewidth]{2020.04.18/object_locations_gazebo_fixed.png}
                    \label{fig:tag_gazebo}}
                    \quad
                    \subfigure[Rviz visualization]{%
                    \includegraphics[width=0.45\linewidth]{2020.04.18/object_locations_rviz_fixed.png}
                    \label{fig:tag_rviz}}
                    \caption{(a) Gazebo visualization of world. (b) Soda can and starting pose of HSR in the extended grasping phase in the frame of the table}
                    \label{fig:tag}
                \end{figure}
                % \begin{figure}[ht][ht]
    ...
    %     \end{figure}
        ...
        %         \label{fig:idealVel}}
        %         \caption{Ideal position and velocity values at each waypoint. (a) shows a plot of joint positions at each waypoint. (b) shows a plot of joint velocities at each waypoint. Values plotted in (a) and (b) were received from messages published by /follow\_joint\_trajectory/goal topics for the HSR arm and base. This topic publishes joint\_trajectory messages at 10hz, which represent the ideal waypoints for the HSR to follow. Connections between points should be ignored since they are an artifact of plotting with RQT}
        %         \label{fig:IdealTraj}
        % \end{figure}
